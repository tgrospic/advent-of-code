...
module Day01 =
  ...
  let part1 () = Assert.Equal("Distance", 181, distance puzzleInput)
  let part2 () = Assert.Equal("First intersection distance", 140, firstIntersectionDistance puzzleInput)
  let results = [
    testCase "Part 1" <| part1
    testCase "Part 2" <| part2
  ]
